    ...
    const result = allProducts.filter(
      (p) =>
        ...
        (selectedDesigners.length
          ? selectedDesigners.includes(p.designer)
          : true),
    );
  ...
  return (
    <div className="product-list-page">
      ...
      <aside className={`advanced-filter-bar ${showFilters ? "show" : "hide"}`}>
        ...
        <div
          className={`filter-group ${accordionState.Gender ? "active" : ""}`}
        >
        ...
        {/* Category */}
        <div
          className={`filter-group ${accordionState.Category ? "active" : ""}`}
        >
        ...
        {categoryTree[gender][selectedCategory] && (
          <div
            className={`filter-group ${accordionState.Subcategory ? "active" : ""}`}
          >
            ...
            <div className="filter-options">
              {Object.keys(categoryTree[gender][selectedCategory]).map(
                (sub) => (
        ...
        {/* Subtype */}
        {categoryTree[gender][selectedCategory]?.[selectedSubcategory]?.length >
          0 && (
          <div
            className={`filter-group ${accordionState.Subtype ? "active" : ""}`}
          >
            ...
            <div className="filter-options">
              {categoryTree[gender][selectedCategory][selectedSubcategory].map(
                (st) => (
                  <div className="custom-checkbox" key={st}>
                    <input
                      ...
                      onChange={() =>
                        toggleSelect(st, setSelectedSubtypes, selectedSubtypes)
                      }
                    />
            ...
            {sizes.map((size) => (
              <div className="custom-checkbox" key={size}>
                <input
                  ...
                  onChange={() =>
                    toggleSelect(size, setSelectedSizes, selectedSizes)
                  }
                />
            ...
            {colors.map((color) => (
              <div className="custom-checkbox" key={color}>
                <input
                  ...
                  onChange={() =>
                    toggleSelect(color, setSelectedColors, selectedColors)
                  }
                />
        ...
        {/* Fabric */}
        <div
          className={`filter-group ${accordionState.Fabric ? "active" : ""}`}
        >
            ...
            {fabrics.map((fabric) => (
              <div className="custom-checkbox" key={fabric}>
                <input
                  ...
                  onChange={() =>
                    toggleSelect(fabric, setSelectedFabrics, selectedFabrics)
                  }
                />
        ...
        {/* Designer */}
        <div
          className={`filter-group ${accordionState.Designer ? "active" : ""}`}
        >
            ...
            {designers.map((brand) => (
              <div className="custom-checkbox" key={brand}>
                <input
                  ...
                  onChange={() =>
                    toggleSelect(brand, setSelectedDesigners, selectedDesigners)
                  }
                />
