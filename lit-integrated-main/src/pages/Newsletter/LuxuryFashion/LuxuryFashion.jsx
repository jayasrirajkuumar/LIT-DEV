    ...
    return (
      <section className="lf-section">
        ...
        <p className="no-posts-message">
          No luxury fashion articles available.
        </p>
      </section>
    );
  }
      ...
      <div className="lf-grid-container">
        {featuredPosts[0] && (
          <div className="lf-card-wrapper lf-card-1">
            <Card
              {...featuredPosts[0]}
              articleUrl={`/newsletter/article/${featuredPosts[0].slug}`}
            />
          </div>
        )}
        {featuredPosts[1] && (
          <div className="lf-card-wrapper lf-card-2">
            <Card
              {...featuredPosts[1]}
              articleUrl={`/newsletter/article/${featuredPosts[1].slug}`}
            />
          </div>
        )}
        {featuredPosts[2] && (
          <div className="lf-card-wrapper lf-card-3">
            <Card
              {...featuredPosts[2]}
              articleUrl={`/newsletter/article/${featuredPosts[2].slug}`}
            />
          </div>
        )}
        {featuredPosts[3] && (
          <div className="lf-card-wrapper lf-card-large">
            <Card
              {...featuredPosts[3]}
              articleUrl={`/newsletter/article/${featuredPosts[3].slug}`}
            />
          </div>
        )}
        {featuredPosts[4] && (
          <div className="lf-card-wrapper lf-card-tall">
            <Card
              {...featuredPosts[4]}
              articleUrl={`/newsletter/article/${featuredPosts[4].slug}`}
            />
          </div>
        )}
      </div>
