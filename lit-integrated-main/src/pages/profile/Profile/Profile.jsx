    ...
    <div className="profile-page">
      ...
      <main className="profile-content">
            ...
            <div className="profile-achievements-list">
              <div className="achievement-item">
                <span className="achievement-icon">
                  <img src="/src/assets/shoe.png" alt="Footwear" />
                </span>
              ...
              <div className="achievement-item">
                <span className="achievement-icon">
                  <img src="/src/assets/dress.png" alt="Clothing" />
                </span>
              ...
              <div className="achievement-item">
                <span className="achievement-icon">
                  <img src="/src/assets/accesories.png" alt="Accessories" />
                </span>
              ...
              <div className="achievement-item">
                <span className="achievement-icon">
                  <img src="/src/assets/bag.png" alt="Bags" />
                </span>
            ...
            <div className="profile-badges-flex">
              ...
              <div className="profile-points">
                ...
                <div className="points-value">
                  2803<span className="points-arrow">↑</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mobile-stats-achievements-wrapper">
          ...
          <div
            className="profile-badges-card mobile-profile-badges-card"
            onClick={handleBadgesCardClick}
            tabIndex={0}
            role="button"
            aria-label="View Badges"
          ...
          >
            ...
            <ul className="friends-list">
              <li className="friend-item">
                <img
                  src="/src/assets/avatars/new-friend-avatar.png"
                  alt="Friend Avatar"
      ...
      {showBadgesPopup && (
        <div
          className="badges-popup-overlay"
          ...
          >
            ...
            <div
              ...
              style={{
                ...
                fontSize: "2.5vw",
                letterSpacing: 3,
                fontFamily: "Krona, sans-serif",
              }}
            >
              BADGES
            </div>
            <div
              className="badges-img-row"
              style={{
                display: "flex",
                justifyContent: "center",
                alignItems: "end",
            ...
            >
              win 11 games to achieve the badges
            </div>
          </div>
        </div>
      )}
