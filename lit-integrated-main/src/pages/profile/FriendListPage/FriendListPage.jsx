      ...
      {modalOpen &&
        (isStrictMobile() ? (
          <div className="profile-modal-backdrop" onClick={closeModal}>
            <div
              className="profile-modal mobile-profile-modal"
      ...
      {successPopupOpen && successUser && (
        <div className="success-popup-backdrop">
          <div className="success-popup-modal">
            ...
            <img
              src={successUser.avatar}
              alt={successUser.name}
              className="success-popup-avatar"
            />
            <div className="success-popup-message">
              is now in your Friend List!
            </div>
            <button className="success-popup-btn" onClick={handleSuccessClose}>
              Add More Friends
            </button>
          </div>
        </div>
        ...
        <div className="profile-modal-backdrop">
          <div className="profile-modal request-profile-modal">
            <button
              ...
              onClick={handleRequestProfileClose}
            >
              &times;
            </button>
            <div className="profile-modal-header">
              <img
                src={requestProfileUser.avatar}
                alt={requestProfileUser.name}
                className="profile-avatar"
                style={{
                  width: 100,
                  height: 100,
              ...
              <div>
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                  ...
                  <img
                    ...
                    onClick={() => handleAcceptClick(requestProfileUser)}
                  />
                  <button
                    className="delete-icon"
                    onClick={() => handleDeleteClick(requestProfileUser)}
                  >
                    <img
                      src={declImg}
                      alt="Delete"
        ...
        <div className="delete-popup-backdrop">
          <div className="delete-popup-modal pending-delete-popup-modal">
            ...
            <div className="delete-popup-message">
              Confirm to delete <b>{pendingDeleteTarget.name}</b> from your
              pending requests?
            </div>
            <div className="delete-popup-actions">
              <button
                className="delete-popup-btn cancel"
                onClick={handlePendingDeleteCancel}
              >
                Cancel
              </button>
              <button
                className="delete-popup-btn ok"
                onClick={handlePendingDeleteConfirm}
              >
                OK
              </button>
            </div>
        ...
        {isDesktop() && (
          <div className="sidebar">
            <div className="quick-menu">
              ...
              <ul>
                <li>
                  <Link to="/game-modes" className="menu-link">
                    Game Mode
                  </Link>
                </li>
                <li>Tournaments</li>
                  ...
                  >
                    <img
                      ...
                      style={{
                        ...
                        borderRadius: 12,
                        background:
                          "radial-gradient(309.68% 308.36% at 53.98% 55.95%, rgba(0, 0, 0, 0.80) 0%, rgba(147, 51, 234, 0.40) 50%)",
                        padding: 6,
                      }}
                    />
                    <div>
              ...
              {activeTab === "friend-list"
                ? filteredFriends.map((friend) => (
                    <div key={friend.id} className="friend-row">
                      ...
                      >
                        ...
                        />
                        <span className="name" style={{ minWidth: 120 }}>
                          {friend.name}
                        </span>
                      </div>
                      <div style={{ flex: 1 }} />
                      <span
                        className="score mobile-hide-score"
                        style={{
                          display: "flex",
                          alignItems: "center",
                          gap: 6,
                ...
                : filteredPendingRequests.map((request) => (
                    ...
                    >
                      <div
                        className="frnd-show"
                        onClick={() => handleRequestProfileClick(request)}
                        style={{ cursor: "pointer" }}
                      >
                        <img
                          src={request.avatar}
                      ...
                      >
                        ...
                        <button
                          className="delete-icon"
                          onClick={() => handlePendingDeleteClick(request)}
                        >
                          <img
                            src={declImg}
                            alt="Delete"
