  ...
  return (
    <div className="privacy-policy-page">
      ...
      <main className="privacy-content">
        <p>
          At LIT, we value your privacy and are committed to safeguarding your
          personal data.
        </p>
        ...
        <section>
          ...
          <ul>
            ...
            <li>
              We only share your data with trusted vendors for shipping,
              payments, and analytics under strict confidentiality agreements.
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ul>
            <li>
              We use SSL encryption and secure storage solutions to protect your
              information.
            </li>
          </ul>
        </section>
        ...
        <section>
          <h2>5. Your Rights</h2>
          <p>
            You can access, edit, or delete your data anytime by contacting us
            at{" "}
