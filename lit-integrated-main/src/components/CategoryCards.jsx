      ...
      <div className="category-card-wrapper">
        <div className="category-card men">
          ...
          <div className="category-options">
            <Link
              to="/products"
              state={{ gender: "Men", category: null }}
              className="option"
            >
              Shop All
            </Link>
            ...
            <Link
              to="/products"
              state={{ gender: "Men", category: "Footwear" }}
              className="option"
            >
              Shoes
            </Link>
            <Link
              to="/products"
              state={{ gender: "Men", category: "Bags" }}
              className="option"
            >
              Bags
            </Link>
            <Link
              to="/products"
              state={{ gender: "Men", category: "Accessories" }}
              className="option"
            >
              Accessories
            </Link>
        ...
        <div className="category-title fade-in" ref={menTitleRef}>
          Men's Fashion
        </div>
      </div>
      ...
      <div className="category-card-wrapper">
        <div className="category-card women">
          ...
          <div className="category-options">
            <Link
              to="/products"
              state={{ gender: "Women", category: null }}
              className="option"
            >
              Shop All
            </Link>
            ...
            <Link
              to="/products"
              state={{ gender: "Women", category: "Footwear" }}
              className="option"
            >
              Shoes
            </Link>
            <Link
              to="/products"
              state={{ gender: "Women", category: "Bags" }}
              className="option"
            >
              Bags
            </Link>
            <Link
              to="/products"
              state={{ gender: "Women", category: "Accessories" }}
              className="option"
            >
              Accessories
            </Link>
        ...
        <div className="category-title fade-in" ref={womenTitleRef}>
          Women's Fashion
        </div>
      </div>
    </section>
