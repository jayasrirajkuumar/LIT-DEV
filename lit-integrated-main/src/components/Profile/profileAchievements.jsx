      ...
      <div className="profile-achievements-list">
        <div className="achievement-item">
          <span className="achievement-icon">
            <img
              src={isStrictMobile ? shoeIcon : "/src/assets/shoe.png"}
              alt="Footwear"
            />
          </span>
        ...
        <div className="achievement-item">
          <span className="achievement-icon">
            <img
              src={isStrictMobile ? dressIcon : "/src/assets/dress.png"}
              alt="Clothing"
            />
          </span>
        ...
        <div className="achievement-item">
          <span className="achievement-icon">
            <img
              src={
                isStrictMobile ? accessoriesIcon : "/src/assets/accesories.png"
              }
              alt="Accessory"
            />
          </span>
        ...
        <div className="achievement-item">
          <span className="achievement-icon">
            <img
              src={isStrictMobile ? bagIcon : "/src/assets/bag.png"}
              alt="Bags"
            />
          </span>
