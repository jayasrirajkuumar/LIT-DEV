...
const PhonePeLogo = () => (
  <img
    src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/71/PhonePe_Logo.svg/2560px-PhonePe_Logo.svg.png"
    alt="PhonePe"
  />
);
const PaytmLogo = () => (
  <img
    src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/24/Paytm_Logo.svg/2560px-Paytm_Logo.svg.png"
    alt="Paytm"
  />
);
const AmazonPayLogo = () => (
  <img
    src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/ae/Amazon_Pay_logo.svg/2560px-Amazon_Pay_logo.svg.png"
    alt="Amazon Pay"
  />
);
...
const UpiForm = () => {
  ...
  return (
    <div className="upi-form-compact">
      ...
      <div>
        <label htmlFor="upiId" className="upi-section-label">
          Enter UPI ID
        </label>
        <div className="upi-input-wrapper">
          ...
          {isVerified && (
            <CheckCircle className="upi-status-icon verified" size={20} />
          )}
          {error && !isVerifying && (
            <XCircle className="upi-status-icon error" size={20} />
          )}
        </div>
