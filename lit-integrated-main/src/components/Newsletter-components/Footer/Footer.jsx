    ...
    <footer className={`footer-container${className ? ` ${className}` : ""}`} id="footer-community-section">
      <div className="footer-content">
        <div className="footer-main">
          <div
            className="footer-logo-section dropdown-container"
            ref={dropdownRef}
          >
            <div
            ...
            {dropdownOpen && (
              <div className="footer-dropdown">
                <Link
                  to="/admin/login?redirect=newsletters"
                  className="dropdown-item"
                >
                  Newsletters
                </Link>
                <Link
                  to="/admin/login?redirect=ecommerce"
                  className="dropdown-item"
                >
                  Ecommerce
                </Link>
        ...
        <div className="footer-secondary">
          ...
          <div className="footer-contact-section">
            ...
            <div className="footer-contact-item">
              <span>LinkedIn</span>
              <a
                href="https://www.linkedin.com/company/luxury-in-taste-lit/"
                target="_blank"
            ...
            <div className="footer-contact-item">
              <span>Instagram</span>
              <a
                href="https://www.instagram.com/luxuryintaste"
                target="_blank"
                rel="noopener noreferrer"
              >
        ...
        <div className="footer-bottom">
          ...
          <p>
            &copy; {new Date().getFullYear()} Luxury In Taste. All rights
            reserved.
          </p>
        </div>
      </div>
