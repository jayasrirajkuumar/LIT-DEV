  ...
  const cards = [
    {
      ...
      description:
        "Discover new sustainable brands reshaping the market, delve into the latest news on eco-conscious goods, and explore much more in the realm of sustainable fashion.",
      path: "/newsletter?section=sustainable",
    },
    {
      id: 2,
      image: luxuryImg,
      title: "ALL IN LUXURY",
      description:
        "Indulge in the opulence of high-end fashion, showcasing the latest trends, exclusive releases, and the epitome of luxury in every stitch and design.",
      path: "/newsletter?section=luxury",
    },
    {
      id: 3,
      image: fashionImg,
      ...
      description:
        "Stay ahead with real-time insights into the fast-paced world of fashion. Selected rapid trends, quick fashion updates, and evolving fashion landscape.",
      path: "/newsletter?section=fast",
    },
    {
      id: 4,
      image: sneakerImg,
      ...
      description:
        "Step into the sneaker culture with a spotlight on the latest drops, exclusive releases, and must-have kicks in the sneaker world.",
      path: "/newsletter?section=sneakers",
    },
  ];
    ...
    <section className="newsletter-container flex min-h-dvh w-full max-w-full flex-col justify-center px-[clamp(1rem,10vw,12rem)] py-16 max-sm:px-4" aria-labelledby="landing-newsletter-title">
      <div className="newsletter-header w-full max-w-none px-0">
        ...
        <div className="cta-buttons">
          <Link to="/newsletter" className="explore-btn">
            Explore Newsletter
          </Link>
