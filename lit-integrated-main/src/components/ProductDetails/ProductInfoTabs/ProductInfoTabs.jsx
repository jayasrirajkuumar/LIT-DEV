      ...
      <div className="size-guide-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="size-chart-container">
          <div className="size-chart">
            <div className="size-column selected">
              <h4>A. XS is equivalent to a IT 38</h4>
              <p>
                <span>DE</span>
                <span>32</span>
              </p>
            ...
            <div className="size-column">
              <h4>A. S is equivalent to a IT 40</h4>
              <p>
                <span>DE</span>
                <span>34</span>
              </p>
...
const SizeAndFitInfo = ({ sizeAndFit = {}, onOpenSizeGuide }) => (
  <div className="size-fit-content">
    ...
    <button onClick={onOpenSizeGuide} className="size-guide-link">
      ...
      >
        <path d="M4 10V17" stroke="currentColor" strokeWidth="1.5" />
        <path d="M8 7V17" stroke="currentColor" strokeWidth="1.5" />
        <path d="M12 4V17" stroke="currentColor" strokeWidth="1.5" />
        <path d="M16 7V17" stroke="currentColor" strokeWidth="1.5" />
          ...
          <div className="accordion-layout">
            {sections.map((section) => (
              <div key={section.id} className="accordion-item">
                ...
                <div
                  className={`accordion-content ${activeSection === section.id ? "active" : ""}`}
                >
