    ...
    <div className="featured-brands">
      <div className="brand-card">
        ...
        <div className="brand-text">
          ...
          <p>
            Parisian cool styles at unreal prices? <em>Oui merci</em>
          </p>
      ...
      <div className="brand-card">
        ...
        <div className="brand-text">
          ...
          <p>
            Razor-sharp tailoring, dream dresses and sure-fire staples that{" "}
            <strong>NEVER</strong> miss
          </p>
          <button className="shop-btn">SHOP NOW</button>
        </div>
      </div>
