...
const Shop = () => {
  ...
  const sustainableText =
    "Our sustainable e-commerce platform offers a curated selection of eco-friendly products, from fashion to everyday essentials. Discover brands committed to sustainability, reduce your carbon footprint, and shop with a purpose. Join us in making a positive impact.";
  const luxuryText =
    "Our luxury e-commerce platform offers a curated selection of the finest luxury products with exclusive discounts. From timeless pieces to everyday luxury, only on our platform.";
    ...
    <section className="shop-container flex min-h-dvh w-full max-w-full flex-col justify-center px-[clamp(1rem,10vw,12rem)] py-16 max-sm:px-4" aria-labelledby="landing-shop-title">
      <div className="shop-header w-full max-w-none px-0">
        ...
        <p>
          ...
          Discounts on Luxury Goods, and Much More only on Our Platform.
        </p>
      </div>
      ...
      <div className="shop-cards w-full max-w-none px-0">
        <div className="shop-card">
          ...
          <div className="shop-card-image">
            <img
              src={shopSustainableImage}
              alt="Sustainable Fashion"
              id="shop-sustainable-image"
            />
          </div>
        </div>
