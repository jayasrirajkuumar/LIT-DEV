...
const initialProducts = [
  {
    ...
    discount: "40%",
    image:
      "https://www.theoutnet.com/variants/images/46376663162939930/E/w520_q80.jpg",
  },
  {
    id: 2,
    name: "Y-3",
    ...
    discount: "50%",
    image:
      "https://www.theoutnet.com/variants/images/46376663162931947/R/w520_q80.jpg",
  },
  {
    id: 3,
    ...
    discount: "50%",
    image:
      "https://www.theoutnet.com/variants/images/1647597289021347/Q/w520_q80.jpg",
  },
];
  ...
  return (
    <div className="vp-section">
      ...
      <div className="vp-carousel-wrapper">
        <button className="vp-arrow left" onClick={() => scroll("left")}>
          &#10094;
        </button>
        ...
        <button className="vp-arrow right" onClick={() => scroll("right")}>
          &#10095;
        </button>
      </div>
    </div>
