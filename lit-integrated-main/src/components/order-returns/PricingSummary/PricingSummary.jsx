    ...
    <div className={`pricing-summary-container ${isOpen ? "open" : ""}`}>
      ...
      <div className="summary-header" onClick={toggleOpen}>
        ...
        <div className="header-right">
          <span className="header-total-price">
            ₹{formatPrice(pricing.totalPaid)}
          </span>
      ...
      <div className="summary-details-content">
        <div className="details-header">
          ...
          <button onClick={toggleOpen} className="close-button">
            <X size={20} />
          </button>
        </div>
          ...
          {pricing.productDiscount > 0 && (
            <div className="price-row">
              ...
              <span className="discount-value">
                -₹{formatPrice(pricing.productDiscount)}
              </span>
            </div>
          )}
